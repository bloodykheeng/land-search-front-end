      ...
      >
        ...
        <div className="contentContainer">
          <div style={{ display: "flex", flexWrap: "wrap" }}>
            <MyButton
              active={tenuretypesclick}
              placeholder="Tenure Types"
              style={{ margin: "10px" }}
              onClick={() => {
