let cldcolumn = [
    ...
    { field: 'Year_Of_Evaluation', headerName: 'Year_Of_Evaluation', minWidth: 300 , type : "dateTime",valueGetter : ({value})=> value && new Date(value) },
    { field: 'Comments', headerName: 'Comments', minWidth: 350  },
    { field: 'Date_of_the_Interview', headerName: 'Date_of_the_Interview', minWidth: 300 , type : "dateTime",valueGetter : ({value})=> value && new Date(value)  },
    ...
    { field: 'CreationDate', headerName: 'CreationDate', minWidth: 300 , type : "dateTime",valueGetter : ({value})=> value && new Date(value)  },
    { field: 'Creator_Name', headerName: 'Creator_Name', minWidth: 300  },
    { field: 'EditDate', headerName: 'EditDate', minWidth: 300 , type : "dateTime",valueGetter : ({value})=> value && new Date(value)  },
    ...
    { field: 'regDateAndTime', headerName: 'regDateAndTime', minWidth: 300, type : "dateTime",valueGetter : ({value})=> value && new Date(value)  },
...
let ownercolumn = [
    ...
    { field: 'Date_Of_Birth', headerName: 'Date_Of_Birth', minWidth: 400 ,type :"datetime" , valueGetter : ({value})=> value && new Date(value)},
